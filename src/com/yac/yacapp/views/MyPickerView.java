...
public class MyPickerView extends View
{
	...
	{
		mDataList = datas;
		mCurrentSelected = 0;//datas.size() / 2;
		invalidate();
	}
	...
	private void drawData(Canvas canvas)
	{
		...
		//System.out.println("big text size:"+size);
		...
		//System.out.println("mCurrentSelected:"+mCurrentSelected+",mDataList.size:"+mDataList.size());
		// 绘制上方data
	...
	private void drawOtherText(Canvas canvas, int position, int type)
	{
		...
		float size = (mMaxTextSize - mMinTextSize) * scale + mMinTextSize;
		//System.out.println("small text size:"+size);
		mPaint.setTextSize(size);
		mPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scale + mMinTextAlpha));
