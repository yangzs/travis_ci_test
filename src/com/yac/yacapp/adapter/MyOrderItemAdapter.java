...
public class MyOrderItemAdapter extends BaseAdapter {
	...
	public MyOrderItemAdapter(Context context, List<OrderProduct> products){
...
//			view.setLayoutParams(params);
		...
		holder.item_product_number_tv.setText(mContext.getString(R.string.product_num, product.unit_count));//(String.valueOf(product.unit_count));
